...
pub const KE_INIT_SPECIFIC_STATE_PATTERN: [u8; 5] = [
    0x75, 0x2D, 0x0F, 0xB6, 0x15
];

pub const KI_IS_NX_SUPPORTED: [u8; 9] = [0x74, 0x2A, 0xB9, 0x80, 0x00, 0x00, 0xC0, 0x0F, 0x32];
